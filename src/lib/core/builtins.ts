...
export const pageBreakDefinition: ComponentDefinition = {
  type: 'page-break',
  label: 'Page break',
  icon: '✂️',
  category: 'layout',
...
export const watermarkDefinition: ComponentDefinition = {
  type: 'watermark',
  label: 'Watermark',
  icon: '💧',
  category: 'overlay',
...
export const repeaterDefinition: ComponentDefinition = {
  type: 'repeater',
  label: 'Repeater',
  icon: '🔁',
  category: 'layout',
...
export const conditionalDefinition: ComponentDefinition = {
  type: 'conditional',
  label: 'Conditional',
  icon: '❓',
  category: 'layout',
...
export const builtinDefinitions: ComponentDefinition[] = [
  textDefinition,
  imageDefinition,
  containerDefinition,
  columnsDefinition,
