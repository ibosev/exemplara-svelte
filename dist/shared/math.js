...
export function stepZoom(current, direction, step = 0.25, min = 0.25, max = 3) {
...
export function fitZoom(contentWidth, viewportWidth, padding = 64, max = 1) {
...
export function formatPageNumber(n, format = 'numeric') {
    switch (format) {
        case 'roman':
            return toRoman(n);
        case 'alpha':
