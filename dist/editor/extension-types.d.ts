...
import type { TemplateExpressionEvaluator, TemplateExpressionFormatter, TemplateExpressionRuntime } from '../shared/expression.js';
import type { EditorCommandDefinition, EditorKeybindingDefinition, EditorMenuItemDefinition } from './actions.js';
...
export declare const DEFAULT_PANEL_ORDER = 50;
...
export interface EditorOutlineAction {
    ...
    execute: (editor: EditorContext, node: ComponentNode) => boolean | void | Promise<boolean | void>;
}
